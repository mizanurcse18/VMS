...
{
    public class DAVendorType : DABase, IDAVendorType
    {

        #region Properties

        private DAVendorType entityDA;

        #endregion Properties

        #region Methods

        public long Save(VendorType entity)
        {
            throw new NotImplementedException();
        }

        public long Update(VendorType entity)
        {
            throw new NotImplementedException();
        }
        ...
        public List<VendorType> Get(Int32 pageSize, Int32 currentPage, String sortExpression, String filterExpression)
        {
            DataTable dt = new DataTable();
            List<VendorType> listOfObj = new List<VendorType>();
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("VendorType", connection);
            ...
            listOfObj = dt.AsEnumerable().Select(dr => new VendorType()
            {
                ID = dr.GetString("ID"),
